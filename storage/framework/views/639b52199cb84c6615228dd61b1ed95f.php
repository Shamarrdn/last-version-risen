...
<script>
    ...
    function loadExistingInventoryDataForEdit() {
        // Initialize inventoryRows array if not exists
        ...
        Object.entries(window.existingInventoryData).forEach(([key, inventory]) => {
            ...
            const rowHtml = `
                <div class="inventory-row card mb-3" id="${rowId}" data-existing-id="${inventory.id || ''}">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-2">
                                <button type="button" class="btn btn-danger btn-sm" onclick="removeExistingInventoryRow('${rowId}', '${inventory.id || ''}')">
