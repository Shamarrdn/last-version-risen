...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'لوحة التحكم'); ?> - RISEN</title>

    <!-- Styles -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.rtl.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Tajawal:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/admin/admin-layout.css')); ?>">
...
<body class="h-100">
    <div class="admin-layout">
        ...
        <aside class="sidebar shadow-sm" id="sidebar">
            <div class="sidebar-header">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-logo" style="white-space: normal; line-height: 1.2;">
                    <div>
                        RISEN
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.products.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.products.index') ? 'active' : ''); ?>">
                    ...
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.products.inventory')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.products.inventory') ? 'active' : ''); ?>">
                            <i class="fas fa-warehouse"></i>
                            <span class="nav-title">المخزون</span>
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.sizes-colors.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.sizes-colors.*') ? 'active' : ''); ?>">
                            <i class="fas fa-palette"></i>
                            <span class="nav-title">الألوان والمقاسات</span>
                        </a>
                    </div>
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.sales.statistics')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.sales.statistics') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.quantity-discounts.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.quantity-discounts.*') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="<?php echo e(route('admin.orders.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.orders.index') ? 'active' : ''); ?>">
                            <i class="fas fa-shopping-cart"></i>
                            <span class="nav-title">الطلبات</span>
                        </a>
                    </div>
                                            <div class="nav-item">
                            <a href="<?php echo e(route('admin.orders.assigned')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.orders.assigned') ? 'active' : ''); ?>">
                                <i class="fas fa-user-check"></i>
                                <span class="nav-title">طلباتي المخصصة</span>
                            </a>
                        </div>
                        <div class="nav-item">
                            <a href="<?php echo e(route('admin.orders.unassigned')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.orders.unassigned') ? 'active' : ''); ?>">
                                <i class="fas fa-clock"></i>
                                <span class="nav-title">الطلبات غير المخصصة</span>
                            </a>
                        </div>
                        <div class="nav-item">
                            <a href="<?php echo e(route('admin.transfers.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.transfers.*') ? 'active' : ''); ?>">
                                <i class="fas fa-exchange-alt"></i>
                                <span class="nav-title">نقل الطلبات</span>
                            </a>
                        </div>
                        <div class="nav-item">
                            <a href="<?php echo e(route('admin.orders.invited')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.orders.invited*') ? 'active' : ''); ?>">
            ...
            <nav class="navbar navbar-expand-lg navbar-light glass-effect">
                <div class="container-fluid">
                    <div class="d-flex align-items-center">
                        <div>
                            <h1 class="h4 mb-0 page-title text-truncate"><?php echo $__env->yieldContent('page_title', 'لوحة التحكم'); ?></h1>
                            <div class="page-subtitle"><?php echo $__env->yieldContent('page_subtitle', 'مرحباً بك في لوحة التحكم'); ?></div>
                        </div>
                    </div>
    ...
    <script>
        ...
        if (typeof jQuery === 'undefined') {
            document.write('<script src="<?php echo e(asset("js/jquery-3.6.0.min.js")); ?>"><\/script>');
        }
    </script>
...
<?php /**PATH C:\Users\ADMIN\Desktop\projects\risenn\RISEN\resources\views/layouts/admin.blade.php ENDPATH**/ ?>