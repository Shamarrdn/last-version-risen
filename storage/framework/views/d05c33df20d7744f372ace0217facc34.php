...
<?php $__env->startSection('title', 'طلباتي المخصصة'); ?>
<?php $__env->startSection('page_title', 'طلباتي المخصصة'); ?>
                    ...
                    <div class="orders-container">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h3 class="text-white mb-0"><?php echo e($stats['total_orders']); ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h3 class="text-white mb-0"><?php echo e($stats['completed_orders']); ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h3 class="text-white mb-0"><?php echo e($stats['processing_orders']); ?></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h3 class="text-white mb-0"><?php echo e(number_format($stats['total_revenue'], 2)); ?> ريال</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body">
                                        <form method="GET" action="<?php echo e(route('admin.orders.assigned')); ?>" class="row g-3 align-items-end">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-12 d-flex justify-content-end gap-2">
                                                ...
                                                <a href="<?php echo e(route('admin.orders.assigned')); ?>" class="btn btn-light">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div>
                                                                        <h6 class="mb-0"><?php echo e($order['customer_name']); ?></h6>
                                                            ...
                                                            <td><?php echo e(number_format($order['original_amount'], 2)); ?> ريال</td>
                                                            <td><?php echo e(number_format($order['quantity_discount'], 2)); ?> ريال</td>
                                                            <td><?php echo e(number_format($order['coupon_discount'], 2)); ?> ريال</td>
                                                            <td><?php echo e(number_format($order['total'], 2)); ?> ريال</td>
                                                            <td>
                                                                <span class="badge bg-<?php echo e($order['status_color']); ?>-subtle text-<?php echo e($order['status_color']); ?> rounded-pill">
                                                                    <?php echo e($order['status_text']); ?>

                                                                </span>
                                                            </td>
                                                            <td>
                                                                <span class="badge bg-<?php echo e($order['payment_status_color']); ?>-subtle text-<?php echo e($order['payment_status_color']); ?> rounded-pill">
                                                            ...
                                                            <td>
                                                                <small class="text-success">
                                                                    ...
                                                                    <?php echo e($order['assigned_at']); ?>

                                                                </small>
                                                            </td>
                                                            <td><?php echo e($order['created_at_formatted']); ?></td>
                                                            <td>
                                                                <div class="action-buttons d-flex gap-1">
                                                                    ...
                                                                    <button type="button" 
                                                                            ...
                                                                            data-order-uuid="<?php echo e($order['uuid']); ?>"
                        ...
                        <!-- Pagination -->
                        <?php if(is_a($orders, \Illuminate\Pagination\LengthAwarePaginator::class) && $orders->hasPages()): ?>
                        <div class="row mt-4">
                            <div class="col-12">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.unassign-order-btn', function() {
        ...
        $.ajax({
            url: `<?php echo e(url('/admin/orders')); ?>/${orderUuid}/unassign`,
            method: 'DELETE',
...
<?php echo $__env->make($adminLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\projects\risenn\RISEN\resources\views/admin/orders/assigned.blade.php ENDPATH**/ ?>